...
if  (isset($_GET['cod_matematicas'])) {
  ...
  $query = "SELECT s.cod_matematicas,u.nom_alumno, u.apell_alumno,s.nota1, s.nota2, s.nota3, s.nota4, s.promedio from tb_matematicas s inner join tb_alumno u on s.cod_alumno = u.cod_alumno WHERE cod_matematicas=$cod_matematicas";
...
if (isset($_POST['update'])) {
  ...
  $query = "UPDATE tb_matematicas set  nota1 = '$nota1',
                                        nota2 = '$nota2',
                                        nota3 = '$nota3',
                                        nota4 = '$nota4'
                        
                              WHERE cod_matematicas=$cod_matematicas";
...
<div class="container p-4">
  <div class="row">
    <div class="col-md-4 mx-auto">
      ...
      <!--boton regresars-->
      <a href="3-MATEMATICAS.php" class="btn btn-secondary">
      ...
      <form name="form1" action="editar_matematicas.php?cod_matematicas=<?php echo $_GET['cod_matematicas']; ?>" method="POST" onsubmit="return validar()">
