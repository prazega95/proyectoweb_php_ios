...
if  (isset($_GET['cod_ios'])) {
  ...
  $query = "SELECT s.cod_ios,u.nom_alumno, u.apell_alumno,s.nota1, s.nota2, s.nota3, s.nota4, s.promedio from tb_ios s inner join tb_alumno u on s.cod_alumno = u.cod_alumno WHERE cod_ios=$cod_ios";
...
if (isset($_POST['update'])) {
  ...
  $query = "UPDATE tb_ios set  nota1 = '$nota1',
                               nota2 = '$nota2',
                               nota3 = '$nota3',
                               nota4 = '$nota4'
                        
                              WHERE cod_ios=$cod_ios";
...
<div class="container p-4">
  <div class="row">
    <div class="col-md-4 mx-auto">
      ...
      <!--boton regresars-->
      <a href="5-IOS.php" class="btn btn-secondary">
      ...
      <form name="form1" action="editar_ios.php?cod_ios=<?php echo $_GET['cod_ios']; ?>" method="POST" onsubmit="return validar()">
